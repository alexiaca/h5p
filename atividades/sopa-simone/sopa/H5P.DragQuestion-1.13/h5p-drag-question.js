! function (e) {
    ...
    function o(e, t, n) {
        ...
        w++, this.id = this.contentId = t, this.contentData = n, H5P.Question.call(r, "dragquestion"), this.options = y.extend(!0, {}, {
            ...
            question: {
                settings: {
                    questionTitle: this.contentData && this.contentData.metadata && this.contentData.metadata.title ? this.contentData.metadata.title : "O QUE PODEMOS COLOCAR NA SOPA?",
                    size: {
                        width: 620,
                        height: 310
                    }
