! function (e) {
    ...
    function o(e, t, n) {
        ...
        w++, this.id = this.contentId = t, this.contentData = n, H5P.Question.call(r, "dragquestion"), this.options = y.extend(!0, {}, {
            ...
            question: {
                settings: {
                    questionTitle: this.contentData && this.contentData.metadata && this.contentData.metadata.title ? this.contentData.metadata.title : "VOCÊ CONSEGUE JUNTAR AS OBRAS E SEUS AUTORES? VAMOS TENTAR?",
                    size: {
                        width: 620,
                        height: 310
                    }
    ...
    o.prototype = Object.create(H5P.Question.prototype), o.prototype.constructor = o, o.prototype.registerDomElements = function () {
        ...
        return H5P.createTitle(this.contentData && this.contentData.metadata && this.contentData.metadata.title ? this.contentData.metadata.title : "VOCÊ CONSEGUE JUNTAR AS OBRAS E SEUS AUTORES? VAMOS TENTAR?")
    };
